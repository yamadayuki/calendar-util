...
export default class Calendar {
  constructor(startDay, locale) {
    ...
    this.dayString = i18n.__(WEEK[this.day]);
  }
 ...
 */
function DayError() {
  this.message = 'day must be within 0 to 11 (Sunday is 0)';
  this.toString = () => {
    return this.constructor.name + ': ' + this.message;
  };
}
...
/**
 * LocaleError - Error around Locale.
 */
function LocaleError() {
  this.message = 'locale must be string';
  this.toString = () => {
    return this.constructor.name + ': ' + this.message;
  };
}
